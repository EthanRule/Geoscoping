      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="hidden lg:block text-[#FEFFFE]/60 text-xs">
            ...
            <div className="space-x-4 mt-4 hidden lg:block">
              <a
        ...
        <p className="lg:hidden text-[#FEFFFE]/60 text-xs pt-4">
          &copy; {new Date().getFullYear()} Geoscoping
          <span className="ml-2 bg-[#1C448E] px-2 py-0.5 rounded text-[#FEFFFE] text-xs">
            Beta
          </span>
        ...
        <div className="space-x-4 mt-4 lg:hidden">
          <a
            href="https://github.com/EthanRule/Geoscoping"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="border-t border-[#1C448E]/30 mt-8 pt-4 text-center">
          <div className="text-[#FEFFFE]/40 text-xs flex justify-center items-center flex-wrap gap-2">
            <span>
            ...
            <span className="bg-[#1C448E]/20 px-2 py-1 rounded text-[#FEFFFE]/70 text-xs">
              ...
              {/* Last data update: {new Date().toLocaleDateString()} use MM/DD/YYYY*/}
            </span>
          </div>
